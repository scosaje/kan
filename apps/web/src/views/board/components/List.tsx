    ...
    >
      {(provided) => (
        <div
          ...
          className="dark-text-dark-1000 mr-2 flex h-fit min-w-[10.5rem] flex-1 basis-0 flex-col rounded-md border border-light-400 bg-light-300 py-2 pl-2 pr-1 text-neutral-900 dark:border-dark-300 dark:bg-dark-100 xl:mr-3 2xl:mr-4"
        >
